...
*/
public class AdaptiveSeekingAgentLowInfection<E extends Seeker & AdaptiveGraphTraverser> extends AdaptiveSeekingAgent<E> implements LowInfectionGraphTraverser {
 
  public AdaptiveSeekingAgentLowInfection(GraphController<StringVertex, StringEdge> graphController, String name, ArrayList<Pair<E, Double>> strategyPortfolio, int totalRounds, double cueTriggerThreshold, boolean canReuse) {
