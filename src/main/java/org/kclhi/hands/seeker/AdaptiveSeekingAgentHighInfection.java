...
*/
public class AdaptiveSeekingAgentHighInfection<E extends Seeker & AdaptiveGraphTraverser> extends AdaptiveSeekingAgent<E> implements HighInfectionGraphTraverser {
 
  public AdaptiveSeekingAgentHighInfection(GraphController<StringVertex, StringEdge> graphController, String name, ArrayList<Pair<E, Double>> strategyPortfolio, int totalRounds, double cueTriggerThreshold, boolean canReuse) {
