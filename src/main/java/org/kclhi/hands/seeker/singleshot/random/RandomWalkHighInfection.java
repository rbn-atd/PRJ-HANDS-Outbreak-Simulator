...
*
*/
public class RandomWalkHighInfection extends RandomWalk implements HighInfectionGraphTraverser {

  public RandomWalkHighInfection(GraphController<StringVertex, StringEdge> graphController) {
