...
*
*/
public class RandomWalkMediumVaccineVariableVaccine extends RandomWalk implements MediumVaccineGraphTraverser {

  public RandomWalkMediumVaccineVariableVaccine(GraphController<StringVertex, StringEdge> graphController) {
