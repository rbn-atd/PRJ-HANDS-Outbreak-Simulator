...
*
*/
public class RandomWalkLowInfection extends RandomWalk implements LowInfectionGraphTraverser {

  public RandomWalkLowInfection(GraphController<StringVertex, StringEdge> graphController) {
