...
*
*/
public class RandomWalkLowVaccineVariableVaccine extends RandomWalk implements LowVaccineGraphTraverser {

  public RandomWalkLowVaccineVariableVaccine(GraphController<StringVertex, StringEdge> graphController) {
