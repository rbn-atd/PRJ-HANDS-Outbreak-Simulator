...
*
*/
public class MaxDistanceHighInfection extends MaxDistance implements HighInfectionGraphTraverser {

  public MaxDistanceHighInfection(GraphController<StringVertex, StringEdge> graphController) {
