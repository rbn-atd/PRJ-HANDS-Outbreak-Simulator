...
*
*/
public class RandomWalkHighVaccineVariableVaccine extends RandomWalk implements HighVaccineGraphTraverser {

  public RandomWalkHighVaccineVariableVaccine(GraphController<StringVertex, StringEdge> graphController) {
