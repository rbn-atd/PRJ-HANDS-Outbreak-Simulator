...
*
*/
public class RandomWalkUpperVaccineVariableVaccine extends RandomWalk implements UpperVaccineGraphTraverser {

  public RandomWalkUpperVaccineVariableVaccine(GraphController<StringVertex, StringEdge> graphController) {
