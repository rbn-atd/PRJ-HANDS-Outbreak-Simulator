...
*
*/
public class RandomWalkUpperInfection extends RandomWalk implements UpperInfectionGraphTraverser {

  public RandomWalkUpperInfection(GraphController<StringVertex, StringEdge> graphController) {
