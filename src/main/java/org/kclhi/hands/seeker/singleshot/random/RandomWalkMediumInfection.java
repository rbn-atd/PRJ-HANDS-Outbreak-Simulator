...
*
*/
public class RandomWalkMediumInfection extends RandomWalk implements MediumInfectionGraphTraverser {

  public RandomWalkMediumInfection(GraphController<StringVertex, StringEdge> graphController) {
